...
from outlook_calendar_sync.cli import main
from outlook_calendar_sync.utils import get_event


def test_event_parsing():
    tests = [
            "all day event from Wednesday, November 23, 2022 to Friday, November 25, 2022 Nil A/L meb organiser Nil Bozkurt event shown as Free",
